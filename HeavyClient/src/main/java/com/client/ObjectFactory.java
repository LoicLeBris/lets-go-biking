...
public class ObjectFactory {
    ...
    private final static QName _GetItineraryA_QNAME = new QName("http://tempuri.org/", "a");
    private final static QName _GetItineraryB_QNAME = new QName("http://tempuri.org/", "b");
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link String }{@code >}
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "a", scope = GetItinerary.class)
    public JAXBElement<String> createGetItineraryA(String value) {
        return new JAXBElement<String>(_GetItineraryA_QNAME, String.class, GetItinerary.class, value);
    }
     ...
     *     the new instance of {@link JAXBElement }{@code <}{@link String }{@code >}
     */
    @XmlElementDecl(namespace = "http://tempuri.org/", name = "b", scope = GetItinerary.class)
    public JAXBElement<String> createGetItineraryB(String value) {
        return new JAXBElement<String>(_GetItineraryB_QNAME, String.class, GetItinerary.class, value);
    }
